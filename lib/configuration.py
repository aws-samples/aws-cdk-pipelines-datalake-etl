...
# Manual Inputs provided via:
# TODO: Add link to aws-cdk-pipelines-blog-datalake-infrastructure project
GITHUB_TOKEN = 'github_token'
ACCOUNT_ID = 'account_id'
REGION = 'region'
LOGICAL_ID_PREFIX = 'logical_id_prefix'
RESOURCE_NAME_PREFIX = 'resource_name_prefix'
## Ingested from Infrastructure Deployment Outputs
VPC_ID = 'vpc_id'
...
def get_path_mappings() -> dict:
    ...
    return {
        DEPLOYMENT: {
            ...
            GITHUB_REPOSITORY_OWNER_NAME: f'/DataLake/Etl/RepositoryOwnerName',
            GITHUB_REPOSITORY_NAME: f'/DataLake/Etl/RepositoryName',
            LOGICAL_ID_PREFIX: f'/DataLake/Etl/CloudFormationLogicalIdPrefix',
            RESOURCE_NAME_PREFIX: f'/DataLake/Etl/ResourceNamePrefix',
        },
