...
## @params: [JOB_NAME]
args = getResolvedOptions(sys.argv, ['JOB_NAME','txn_bucket_name','txn_sql_prefix_path','dynamodb_tablename','target_databasename','target_tablename','target_bucketname','source_bucketname','source_key','source_system_name','base_file_name','p_year','p_month','p_day','table_name'])
